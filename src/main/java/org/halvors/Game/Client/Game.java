...
public class Game {
	...
	private void initDisplay() {
        try {
            ...
            log(Level.SEVERE, "Failed to initialize graphics device.");
            exit();
        }
    }
    ...
    private void checkOpenGL() {
        ...
        if (!canRunGame) {
            log(Level.SEVERE, "Your GPU driver is not supporting the mandatory versions of OpenGL. Considered updating your GPU drivers?");
            exit();
        }
    ...
    private void initControls() {
        try {
            ...
            log(Level.SEVERE, "Could not initialize controls.");
            exit();
        }
    }

    public void run() {
    	while (gameLoop && !Display.isCloseRequested()) {
    		Display.update();
            Display.sync(60);
    	}
    }
